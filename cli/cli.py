...
from cli.parser import SetupSchemasParser, ScrapeParser, ShowParser, FlightsParser
...
class CommandLineInterface:
    ...
    def __init__(self):
        ...
        self._parser = argparse.ArgumentParser(description="This CLI controls the Nomad List Scrapper", prog="nls",
                                               epilog=epilog,
                                               allow_abbrev=False)
        self._parsers = {'setup-db': SetupSchemasParser(), 'scrape': ScrapeParser(), 'show': ShowParser(), 'fly': FlightsParser()}
